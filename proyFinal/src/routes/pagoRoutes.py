...
@pago_bp.route('/nuevoDeportista', methods=['POST'])
...
@pago_bp.route('/editar/<int:dni>', methods=['POST'])
...
@pago_bp.route('/eliminar/<int:dni>', methods=['POST'])
...
@pago_bp.route('/cambiarEstado/<int:dni>', methods=['POST'])
